                    ...
                    <section>
                        ...
                        <div class="my-4">
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                wire:click="create">Add Image</button>
                        </div>
                        @if ($isOpen)
                            <div class="fixed inset-0 flex items-center justify-center z-50">
                                ...
                                <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                                    ...
                                    <form wire:submit="{{ $postId ? 'update' : 'store' }}">
                                        ...
                                        @if ($oldImage)
                                            <h3>Old Image</h3>
                                            <img src="{{ asset(Storage::url($oldImage)) }}" alt=""
                                                class="h-20 w-40">
                                        @endif
                                        @if ($image)
                                            <h3>New Image</h3>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="file" wire:model="image" id="title"
                                                class="w-full border border-gray-300 px-4 py-2 rounded">
                                            <span class="text-red-500">
                                                @error('image')
                                                    {{ $message }}
                                        ...
                                        <div class="flex justify-end">
                                            <button type="submit"
                                                class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mr-2">{{ $postId ? 'Update' : 'Create' }}
                                            </button>
                                            <button type="button"
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 text-gray-900">
                                            <img src="{{ asset(Storage::url($post->image)) }}"
                                                alt="Uploaded Image Preview" style="max-width: 100px;">
                                        </td>
